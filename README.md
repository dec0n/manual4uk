...
9. **WinPE с пакетом диагностических программ**  
   ...
   - **Ссылка**: Рекомендуется сборка Sergei Strelec WinPE ([https://sergeistrelec.ru/](https://sergeistrelec.ru/)). 
...
12. **Nmap**  
    - **Назначение**: Сканирование сетей и аудит безопасности.  
    - **Ссылка**: [https://nmap.org/download.html](https://nmap.org/download.html)  
    - **Примечание**: Доступен в составе Kali Linux или как отдельный загрузочный образ для сетевого анализа. Используйте в легальных целях.
...
##Наш пак образов которые мы используем:https://cloud.mail.ru/public/UXYz/6ihWMDGrd
